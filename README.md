...
[image1]: https://raw.githubusercontent.com/francnascimento/drl-tennis/master/images/play_demo.gif "Tennis Demo"

# Deep Deterministic Policy Gradients in Multi-agent Tennis
...
For this project, we will not need to install Unity - this is because the udacity group have already built the environment for you, and you can download it from one of the links below. You need only select the environment that matches your operating system:
...
Then place the file in the Repository and unzip (or decompress) the file. 
